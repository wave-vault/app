  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-input bg-background shadow-md hover:bg-accent hover:text-accent-foreground hover:shadow-lg hover:scale-105",
        secondary:
        ...
        glass:
          "glass text-foreground border-white/20 hover:glass-strong hover:border-white/30 hover:scale-105",
        "glass-apple":
          "glass-apple text-foreground border-white/25 hover:glass-apple-strong hover:border-white/35 hover:scale-105",
      },
      size: {
